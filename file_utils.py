...
HEADERS = {
    ...
    ObjectType.oppty.name: "AttachmentPath;AttachmentName;ObjectType;OppotrunityUUID;OpportunityID;OpportunityName;OpportunityTypeCode;SubObjectType;SubObjectUUID;AttachmentUUID;SizeInkB;AttachmentCreator;AttachmentCreationDate(UTC+0);DocumentLink;MimeType;TypeCode;TypeCodeText",
}
...
PATHS = {
    ...
    Mode.prod.name: {
        ObjectType.account.name: {
            FolderType.input_raw.name: "prod/account/input/raw",
            FolderType.input_struct.name: "prod/account/input/struct",
            FolderType.output_error.name: "prod/account/output/error",
            FolderType.output_log.name: "prod/account/output/log",
            FolderType.output_mapping.name: "prod/account/output/mapping",
            FolderType.output_file.name: "prod/account/output/file",
        },
        ObjectType.oppty.name: {
            FolderType.input_raw.name: "prod/opportunity/input/raw",
            FolderType.input_struct.name: "prod/opportunity/input/struct",
            FolderType.output_error.name: "prod/opportunity/output/error",
            FolderType.output_log.name: "prod/opportunity/output/log",
            FolderType.output_mapping.name: "prod/opportunity/output/mapping",
            FolderType.output_file.name: "prod/opportunity/output/file",
        },
        ObjectType.activity.name: {
            FolderType.input_raw.name: "prod/activity/input/raw",
            FolderType.input_struct.name: "prod/activity/input/struct",
            FolderType.output_error.name: "prod/activity/output/error",
            FolderType.output_log.name: "prod/activity/output/log",
            FolderType.output_mapping.name: "prod/activity/output/mapping",
            FolderType.output_file.name: "prod/activity/output/file",
        },
        ObjectType.pricereq.name: {
            FolderType.input_raw.name: "prod/pricereq/input/raw",
            FolderType.input_struct.name: "prod/pricereq/input/struct",
            FolderType.output_error.name: "prod/pricereq/output/error",
            FolderType.output_log.name: "prod/pricereq/output/log",
            FolderType.output_mapping.name: "prod/pricereq/output/mapping",
            FolderType.output_file.name: "prod/pricereq/output/file",
        },
        ObjectType.techtask.name: {
            FolderType.input_raw.name: "D:/techtask/input/raw",
            FolderType.input_struct.name: "D:/techtask/input/struct",
            FolderType.output_error.name: "D:/techtask/output/error",
            FolderType.output_log.name: "D:/techtask/output/log",
            FolderType.output_mapping.name: "D:/techtask/output/mapping",
            FolderType.output_file.name: "D:/techtask/output/file",
        }
    }
}
