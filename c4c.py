...
URLS = {
    Mode.test.name: {
        ...
        ObjectType.charinoopty.name: "https://my327208.crm.ondemand.com/sap/c4c/odata/cust/v1/att_charinopp/CharacteristicsInOpportunityRootCollection?$filter={filter}&$select=ObjectID,OpportunityID,AttachmentAttachmentFolder/ObjectID,AttachmentAttachmentFolder/SizeInkB,AttachmentAttachmentFolder/LastUpdatedBy,AttachmentAttachmentFolder/LastUpdatedOn,AttachmentAttachmentFolder/DocumentLink,AttachmentAttachmentFolder/TypeCode,AttachmentAttachmentFolder/TypeCodeText,AttachmentAttachmentFolder/MimeType,AttachmentAttachmentFolder/Binary&$expand=AttachmentAttachmentFolder&$format=json",
        ObjectType.detspecifhistory.name: "https://my327208.crm.ondemand.com/sap/c4c/odata/cust/v1/att_detspecifhistory/DetailedSpecificationHistoryRootCollection?$filter={filter}&$select=ObjectID,DealName,OpportunityID,OpportunityOriginID,AttachmentAttachmentFolder/ObjectID,AttachmentAttachmentFolder/SizeInkB,AttachmentAttachmentFolder/LastUpdatedBy,AttachmentAttachmentFolder/LastUpdatedOn,AttachmentAttachmentFolder/DocumentLink,AttachmentAttachmentFolder/TypeCode,AttachmentAttachmentFolder/TypeCodeText,AttachmentAttachmentFolder/MimeType,AttachmentAttachmentFolder/Binary&$expand=AttachmentAttachmentFolder&$format=json",
        ObjectType.specifhistory.name: "https://my327208.crm.ondemand.com/sap/c4c/odata/cust/v1/att_specifhistory/SpecificationHistoryRootCollection?$filter={filter}&$select=ObjectID,DealName,OpportunityID,OpportunityOriginID,AttachmentAttachmentFolder/ObjectID,AttachmentAttachmentFolder/SizeInkB,AttachmentAttachmentFolder/LastUpdatedBy,AttachmentAttachmentFolder/LastUpdatedOn,AttachmentAttachmentFolder/DocumentLink,AttachmentAttachmentFolder/TypeCode,AttachmentAttachmentFolder/TypeCodeText,AttachmentAttachmentFolder/MimeType,AttachmentAttachmentFolder/Binary&$expand=AttachmentAttachmentFolder&$format=json",
        ObjectType.discountinoopty.name: "https://my327208.crm.ondemand.com/sap/c4c/odata/cust/v1/att_discountinopp/DiscountInOpportunityRootCollection?$filter={filter}&$select=ObjectID,DealName,OpportunityID,OpportunityOriginID,AttachmentAttachmentFolder/ObjectID,AttachmentAttachmentFolder/SizeInkB,AttachmentAttachmentFolder/LastUpdatedBy,AttachmentAttachmentFolder/LastUpdatedOn,AttachmentAttachmentFolder/DocumentLink,AttachmentAttachmentFolder/TypeCode,AttachmentAttachmentFolder/TypeCodeText,AttachmentAttachmentFolder/MimeType,AttachmentAttachmentFolder/Binary&$expand=AttachmentAttachmentFolder&$format=json",
        ObjectType.expertadvice.name: "https://my327208.crm.ondemand.com/sap/c4c/odata/cust/v1/att_expertadvice/ExpertAdviceParticipationDecisionPlanCollection?$filter={filter}&$select=ObjectID,OpportunityID,AttachmentAttachmentFolder/ObjectID,AttachmentAttachmentFolder/SizeInkB,AttachmentAttachmentFolder/LastUpdatedBy,AttachmentAttachmentFolder/LastUpdatedOn,AttachmentAttachmentFolder/DocumentLink,AttachmentAttachmentFolder/TypeCode,AttachmentAttachmentFolder/TypeCodeText,AttachmentAttachmentFolder/MimeType,AttachmentAttachmentFolder/Binary&$expand=AttachmentAttachmentFolder&$format=json",
        ObjectType.pilotbatch.name: "https://my327208.crm.ondemand.com/sap/c4c/odata/cust/v1/att_pilotbatch/PilotBatchOrderForProductionOfPilotBatchCollection?$filter={filter}&$select=ObjectID,OpportunityID,AttachmentAttachmentFolder/ObjectID,AttachmentAttachmentFolder/SizeInkB,AttachmentAttachmentFolder/LastUpdatedBy,AttachmentAttachmentFolder/LastUpdatedOn,AttachmentAttachmentFolder/DocumentLink,AttachmentAttachmentFolder/TypeCode,AttachmentAttachmentFolder/TypeCodeText,AttachmentAttachmentFolder/MimeType,AttachmentAttachmentFolder/Binary&$expand=AttachmentAttachmentFolder&$format=json",
        ObjectType.specpaymentterms.name: "https://my327208.crm.ondemand.com/sap/c4c/odata/cust/v1/att_specpaymentterms/SpecialPaymentTermsRootCollection?$filter={filter}&$select=ObjectID,DealName,OpportunityID,OpportunityOriginID,AttachmentAttachmentFolder/ObjectID,AttachmentAttachmentFolder/SizeInkB,AttachmentAttachmentFolder/LastUpdatedBy,AttachmentAttachmentFolder/LastUpdatedOn,AttachmentAttachmentFolder/DocumentLink,AttachmentAttachmentFolder/TypeCode,AttachmentAttachmentFolder/TypeCodeText,AttachmentAttachmentFolder/MimeType,AttachmentAttachmentFolder/Binary&$expand=AttachmentAttachmentFolder&$format=json"
    },
    Mode.prod.name: {
        ...
        ObjectType.charinoopty.name: "https://my336064.crm.ondemand.com/sap/c4c/odata/cust/v1/att_charinopp/CharacteristicsInOpportunityRootCollection?$filter={filter}&$select=ObjectID,OpportunityID,AttachmentAttachmentFolder/ObjectID,AttachmentAttachmentFolder/SizeInkB,AttachmentAttachmentFolder/LastUpdatedBy,AttachmentAttachmentFolder/LastUpdatedOn,AttachmentAttachmentFolder/DocumentLink,AttachmentAttachmentFolder/TypeCode,AttachmentAttachmentFolder/TypeCodeText,AttachmentAttachmentFolder/MimeType,AttachmentAttachmentFolder/Binary&$expand=AttachmentAttachmentFolder&$format=json",
        ObjectType.detspecifhistory.name: "https://my336064.crm.ondemand.com/sap/c4c/odata/cust/v1/att_detspecifhistory/DetailedSpecificationHistoryRootCollection?$filter={filter}&$select=ObjectID,DealName,OpportunityID,OpportunityOriginID,AttachmentAttachmentFolder/ObjectID,AttachmentAttachmentFolder/SizeInkB,AttachmentAttachmentFolder/LastUpdatedBy,AttachmentAttachmentFolder/LastUpdatedOn,AttachmentAttachmentFolder/DocumentLink,AttachmentAttachmentFolder/TypeCode,AttachmentAttachmentFolder/TypeCodeText,AttachmentAttachmentFolder/MimeType,AttachmentAttachmentFolder/Binary&$expand=AttachmentAttachmentFolder&$format=json",
        ObjectType.specifhistory.name: "https://my336064.crm.ondemand.com/sap/c4c/odata/cust/v1/att_specifhistory/SpecificationHistoryRootCollection?$filter={filter}&$select=ObjectID,DealName,OpportunityID,OpportunityOriginID,AttachmentAttachmentFolder/ObjectID,AttachmentAttachmentFolder/SizeInkB,AttachmentAttachmentFolder/LastUpdatedBy,AttachmentAttachmentFolder/LastUpdatedOn,AttachmentAttachmentFolder/DocumentLink,AttachmentAttachmentFolder/TypeCode,AttachmentAttachmentFolder/TypeCodeText,AttachmentAttachmentFolder/MimeType,AttachmentAttachmentFolder/Binary&$expand=AttachmentAttachmentFolder&$format=json",
        ObjectType.discountinoopty.name: "https://my336064.crm.ondemand.com/sap/c4c/odata/cust/v1/att_discountinopp/DiscountInOpportunityRootCollection?$filter={filter}&$select=ObjectID,DealName,OpportunityID,OpportunityOriginID,AttachmentAttachmentFolder/ObjectID,AttachmentAttachmentFolder/SizeInkB,AttachmentAttachmentFolder/LastUpdatedBy,AttachmentAttachmentFolder/LastUpdatedOn,AttachmentAttachmentFolder/DocumentLink,AttachmentAttachmentFolder/TypeCode,AttachmentAttachmentFolder/TypeCodeText,AttachmentAttachmentFolder/MimeType,AttachmentAttachmentFolder/Binary&$expand=AttachmentAttachmentFolder&$format=json",
        ObjectType.expertadvice.name: "https://my336064.crm.ondemand.com/sap/c4c/odata/cust/v1/att_expertadvice/ExpertAdviceParticipationDecisionPlanCollection?$filter={filter}&$select=ObjectID,OpportunityID,AttachmentAttachmentFolder/ObjectID,AttachmentAttachmentFolder/SizeInkB,AttachmentAttachmentFolder/LastUpdatedBy,AttachmentAttachmentFolder/LastUpdatedOn,AttachmentAttachmentFolder/DocumentLink,AttachmentAttachmentFolder/TypeCode,AttachmentAttachmentFolder/TypeCodeText,AttachmentAttachmentFolder/MimeType,AttachmentAttachmentFolder/Binary&$expand=AttachmentAttachmentFolder&$format=json",
        ObjectType.pilotbatch.name: "https://my336064.crm.ondemand.com/sap/c4c/odata/cust/v1/att_pilotbatch/PilotBatchOrderForProductionOfPilotBatchCollection?$filter={filter}&$select=ObjectID,OpportunityID,AttachmentAttachmentFolder/ObjectID,AttachmentAttachmentFolder/SizeInkB,AttachmentAttachmentFolder/LastUpdatedBy,AttachmentAttachmentFolder/LastUpdatedOn,AttachmentAttachmentFolder/DocumentLink,AttachmentAttachmentFolder/TypeCode,AttachmentAttachmentFolder/TypeCodeText,AttachmentAttachmentFolder/MimeType,AttachmentAttachmentFolder/Binary&$expand=AttachmentAttachmentFolder&$format=json",
        ObjectType.specpaymentterms.name: "https://my336064.crm.ondemand.com/sap/c4c/odata/cust/v1/att_specpaymentterms/SpecialPaymentTermsRootCollection?$filter={filter}&$select=ObjectID,DealName,OpportunityID,OpportunityOriginID,AttachmentAttachmentFolder/ObjectID,AttachmentAttachmentFolder/SizeInkB,AttachmentAttachmentFolder/LastUpdatedBy,AttachmentAttachmentFolder/LastUpdatedOn,AttachmentAttachmentFolder/DocumentLink,AttachmentAttachmentFolder/TypeCode,AttachmentAttachmentFolder/TypeCodeText,AttachmentAttachmentFolder/MimeType,AttachmentAttachmentFolder/Binary&$expand=AttachmentAttachmentFolder&$format=json"
    }
}
...
def form_filter(object_type, keys):
    ...
    if object_type.name == ObjectType.account.name or object_type.name == ObjectType.activity.name or object_type.name == ObjectType.oppty.name:
