...
URLS = {
    Mode.test.name: {
        ...
        ObjectType.charinoopty.name: "https://my327208.crm.ondemand.com/sap/c4c/odata/cust/v1/att_charinopp/CharacteristicsInOpportunityRootCollection?$filter={filter}&$select=ObjectID,OpportunityID,AttachmentID",
        ObjectType.detspecifhistory.name: "https://my327208.crm.ondemand.com/sap/c4c/odata/cust/v1/att_detspecifhistory/DetailedSpecificationHistoryRootCollection?$filter={filter}&$select=ObjectID,OpportunityID,AttachmentID",
        ...
        ObjectType.discountinoopty.name: "https://my327208.crm.ondemand.com/sap/c4c/odata/cust/v1/att_discountinopp/DiscountInOpportunityRootCollection?$filter={filter}&$select=ObjectID,OpportunityID,AttachmentID",
        ObjectType.expertadvice.name: "https://my327208.crm.ondemand.com/sap/c4c/odata/cust/v1/att_expertadvice/ExpertAdviceParticipationDecisionPlanCollection?$filter={filter}&$select=ObjectID,OpportunityID,AttachmentID",
        ...
        ObjectType.specpaymentterms.name: "https://my327208.crm.ondemand.com/sap/c4c/odata/cust/v1/att_specpaymentterms/SpecialPaymentTermsRootCollection?$filter={filter}&$select=ObjectID,OpportunityID,AttachmentID",
